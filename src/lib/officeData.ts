...
export const officesData: OfficeDetails[] = [
  {
    ...
    mainImage: "/venus.jpg",
    images: [
      { src: "/venus.jpg", alt: "Venus офис - вид 1" },
      { src: "/orion.jpg", alt: "Venus офис - вид 2" },
      { src: "/teniz-towers.jpg", alt: "Venus офис - вид 3" },
      { src: "/koktem-towers.png", alt: "Venus офис - вид 4" },
    ],
    location: "Алматы",
  ...
  },
  {
    ...
    images: [
      { src: "/koktem-towers.png", alt: "Koktem Towers офис - вид 1" },
      { src: "/teniz-towers.jpg", alt: "Koktem Towers офис - вид 2" },
      { src: "/orion.jpg", alt: "Koktem Towers офис - вид 3" },
    ],
    location: "Алматы",
    address: "пр. Достык",
    class: "B+",
