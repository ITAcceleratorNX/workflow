/**
 * Контент объектов по ТЗ «TMK WorkFlow» v1.0 с правками от 07.09.2026.
...
export interface Property {
  ...
  address: string
  shortLabel: string
  /** Краткий текст для карточки на главной */
  cardBlurb: string
  ...
  /**
   * Предупреждение под плашками: часть площадей — варианты одного объёма,
   * а не отдельные лоты. Без него посетитель складывает площади и получает
   * несуществующую цифру.
   */
  variantsNote?: string
  /** Строка под плашками о нарезке площадей, например «Делим от 100 м² под запрос». */
  splitNote?: string
  specs: SpecRow[]
...
const timeSquare: Property = {
  ...
  metaDescription:
    "Time Square — бизнес-центр класса А в Самал-3, Алматы. Свободно ≈ 3 800 м²: коммерция и офисные блоки, подземный паркинг, панорама на горы.",
  ...
  cardBlurb:
    "Премиальный БЦ класса А на Аль-Фараби. Свободно ≈ 3 800 м² — коммерция и офисные блоки, подземный паркинг, вид на горы.",
  map: { lat: 43.2186, lng: 76.949 },
  description: [
    ...
    "Свободно к аренде — около 3 800 м²: коммерческое помещение 400 м² на первом этаже и два офисных блока на 2 и 3 этажах. Офисы сдаются этажом, блоком целиком или обоими блоками сразу — под компанию любого размера.",
  ],
  availability: [
    { area: "400 м²", note: "коммерческое помещение, 1 этаж", rate: "19 000 ₸/м²/мес без НДС" },
    { area: "850 м²", note: "один этаж в офисном блоке", rate: "21 550 ₸/м²/мес без НДС" },
    { area: "1 700 м²", note: "офисный блок целиком, два этажа", rate: "21 550 ₸/м²/мес без НДС" },
    { area: "3 400 м²", note: "оба офисных блока", rate: "21 550 ₸/м²/мес без НДС" },
  ],
  variantsNote:
    "850, 1 700 и 3 400 м² — это варианты одного и того же объёма: этаж в блоке, блок целиком или оба блока. Офисные блоки занимают 2 и 3 этажи, арендовать эти площади одновременно нельзя, складывать их между собой не нужно.",
  splitNote: "Делим площади от 300 м² под запрос",
  specs: [
    { label: "Общая площадь (GBA)", value: "10 000 м²" },
    { label: "Вакантная площадь", value: "≈ 3 800 м²" },
    { label: "Под офисы", value: "3 400 м² — два блока на 2 и 3 этажах" },
    { label: "Под коммерцию", value: "400 м² на первом этаже" },
    { label: "Класс", value: "А" },
    { label: "Год постройки", value: "2024" },
    { label: "Этажность", value: "3" },
    {
      label: "Высота потолков",
      value: "3,5 м в офисных блоках, 4 м в коммерческом помещении",
    },
...
const venus: Property = {
  ...
  metaDescription:
    "Venus — бизнес-центр класса А в Медеуском районе Алматы, ул. Елебекова 10/1. Open Space и кабинетные планировки, потолки 3,9 м, наземный паркинг на 85 машиномест.",
  cover: "/venus.webp",
  ...
  cardBlurb:
    "БЦ класса А в Медеуском районе. Open Space и кабинеты, потолки 3,9 м, наземный паркинг — удобно для команд любого формата.",
  map: { lat: 43.2368, lng: 76.9525 },
  description: [
    "Venus — современный бизнес-центр класса А, расположенный в престижном Медеуском районе Алматы по адресу: ул. Елебекова, 10/1.",
  ...
  availability: [
    { area: "70 м²", note: "офисный блок", rate: "21 500 ₸/м²/мес без НДС" },
    { area: "50 м²", note: "офисный блок", rate: "21 500 ₸/м²/мес без НДС" },
  ],
  specs: [
    { label: "Общая площадь (GBA)", value: "22 000 м²" },
    { label: "Арендопригодная площадь", value: "19 130 м²" },
    { label: "Свободно", value: "120 м²" },
    { label: "Класс", value: "А" },
...
const koktemTowers: Property = {
  ...
  availability: [
    { area: "643 м²", note: "девятый этаж полностью, офисы", rate: "21 500 ₸/м²/мес без НДС" },
  ],
  splitNote: "Делим от 100 м² под запрос",
  specs: [
    { label: "Общая площадь (GBA)", value: "5 148 м²" },
    { label: "Арендопригодная площадь", value: "4 752 м²" },
    { label: "Размер типового этажа", value: "396 м²" },
    { label: "Класс", value: "А" },
